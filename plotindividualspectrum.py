...
#specdirec = '/Users/Nathnael/Documents/GitHub/DR16Q/DATA/plotnormposter/'
specdirec = '/Users/Nathnael/Documents/GitHub/DR16Q/DATA/plotnormposter/'

pp2= PdfPages('spec_XXX.pdf') # normalized pdf

#spectra='spec-6640-56385-0896norm.dr16'
spectra='spec-5039-56220-0625norm.dr16'

zem=z=3.195
topy=1.75
topemlabel=1.25 # This is the location where you want to place the ion labels

n=3 # smooth box car
#x-axis limits of the graph:
wavelength_emit1_initial=1200.  # in restframe
wavelength_emit2_initial=1580.  # in restframe
...
ay1.set_xlabel("Observed Wavelength (A)")
ay1.set_ylabel("Normalized Flux")
...
ay2.set_xlabel("Restframe Wavelength (A)")
