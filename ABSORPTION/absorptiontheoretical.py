...
CONFIG_FILE = sys.argv[1] if len(sys.argv) > 1 else os.getcwd() + "/../theoretical_spectra/TEST_Theoretical.csv"

#SPECTRA_NAME = os.getcwd() + "/../" + "/bh9_b364c3_l-2_al075_mw90_wa423.dat"
#norm_spectra_data = np.loadtxt(TEST)
...
NORM_DIREC = os.getcwd() + "/../" + "/theoretical_spectra/"

# creates directory for output files
OUT_DIREC = os.getcwd() + "/OUTPUT_FILES_THEORETICAL/"
...
norm_spectra_list, redshift_list, calc_snr_list = read_list_spectra(CONFIG_FILE, ["NORM SPECTRA FILE NAME", "REDSHIFT","SNR"]) 
vlast = []
