...
pos_15k = np.where((bi_vmax<15000)&(bi_bi0>0)&(SNR>10))
pos_15kplus = np.where((bi_vmax>15000)&(bi_vmax<25000)&(bi_bi0>0)&(SNR>10))
...
mbh_bal10k,mbh_bal25k   = Parentin14Rank_mbh[pos_10k], Parentin14Rank_mbh[pos_15kplus]
redd_bal10k, redd_bal25k = Parentin14Rank_redd[pos_10k], Parentin14Rank_redd[pos_15kplus]
lbol_bal10k, lbol_bal25k = Parentin14Rank_lbol[pos_10k], Parentin14Rank_lbol[pos_15kplus]
...
# plt.hist(lbol_bal15k,bins=bin_spd, label='BAL <15,000 km/s', color='lightskyblue', alpha = 0.5,
#           )
# plt.hist(lbol_bal15kplus, bins=bin_spd,label='BAL 15,000 km/s<vmin<25,000 km/s', color='dodgerblue',alpha = 0.6,
#           )
# plt.hist(ehvorescale_lbol43k, bins=bin_spd, label='EHVO 30,000 km/s<vmin<37,000 km/s', color= 'magenta', alpha=0.6,
#           )
# plt.hist(ehvorescale_lbol43kplus, bins=bin_spd, label='EHVO vmin>37,000 km/s', color='darkmagenta', alpha = 0.8,
#           )
...
# plt.hist(mbh_bal15k,bins=bin_mbh, label='BAL <15,000 km/s', color='lightskyblue', alpha=0.6 )
# plt.hist(mbh_bal15kplus,bins=bin_mbh, label='BAL 15,000 km/s<vmin<25,000 km/s', color='dodgerblue', alpha=0.6)
# plt.hist(ehvorescale_mbh43k, bins=bin_mbh, label='EHVO 30,000 km/s<vmin<37,000 km/s', color= 'magenta', alpha=0.6,
#           )
# plt.hist(ehvorescale_mbh43kplus, bins=bin_mbh, label='EHVO vmin>37,000 km/s', color='darkmagenta', alpha = 0.8,
#           )
...
# plt.hist(redd_bal15k, bins=bin_redd, label='BAL <15,000 km/s',color='lightskyblue',alpha = 0.6 )
# plt.hist(redd_bal15kplus, bins=bin_redd,label='BAL 15,000 km/s<vmin<25,000 km/s',color='dodgerblue',alpha=0.6)
# plt.hist(ehvorescale_edd43k, bins=bin_redd, label='EHVO 30,000 km/s<vmin<37,000 km/s', color= 'magenta', alpha=0.6,
#           )
# plt.hist(ehvorescale_edd43kplus,bins=bin_redd,  label='EHVO vmin>37,000 km/s', color='darkmagenta', alpha = 0.8,
#           )
...
medehvo37lmbh = sta.median(ehvoin14rank_mbh43k)
medehvo37pluslmbh = sta.median(ehvoin14rank_mbh43kbeyond)
...
medbal37lredd = sta.median(redd_bal15k)
medbal37plusredd = sta.median(redd_bal15kplus)
# sta.median(ehvoin14rank_edd43k)
# sta.median(ehvoin14rank_edd43k)
# sta.median(ehvoin14rank_edd43k)
# sta.median(ehvoin14rank_edd43k)
# sta.median(ehvoin14rank_edd43k)
