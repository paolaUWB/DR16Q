...
specdirec = "/Users/wendygarcia/documents/github/DATA/NORM_DR16Q/"
pp2= PdfPages('spec_XXX.pdf') # normalized pdf

spectra='spec-5998-56087-0294norm.dr16'

zem = z = 2.545
topy=2.6
topemlabel=2.05 # This is the location where you want to place the ion labels

n=5 # smooth box car
#x-axis limits of the graph:
wavelength_emit1_initial=1025.  # in restframe
wavelength_emit2_initial=1700.  # in restframe

vmin= [-35000] #this is for the colored lines
vmax= [-40000]
...
if OVIem == 'yes':
    plt.text(OVIll*(1+zem)-10.,topemlabel,'OVI',color='black',rotation=90,fontname='serif')
