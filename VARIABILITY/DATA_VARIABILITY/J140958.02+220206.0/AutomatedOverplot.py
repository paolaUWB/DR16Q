...
quasardirec = 'J140958.02+220206.0/' # Name of the object you are observing (same name as the directory folder it's contained in). If you don't have these directory names,
...
zem =2.892# redshift of the quasar
coem=zem+1.
