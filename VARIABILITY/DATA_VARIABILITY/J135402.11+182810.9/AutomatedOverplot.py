...
quasardirec = 'J135402.11+182810.9/' # Name of the object you are observing (same name as the directory folder it's contained in). If you don't have these directory names,
...
zem =3.403# redshift of the quasar
coem=zem+1.
