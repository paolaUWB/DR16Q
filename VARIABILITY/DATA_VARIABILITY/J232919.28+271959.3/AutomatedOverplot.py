...
quasardirec = 'J232919.28+271959.3/' # Name of the object you are observing (same name as the directory folder it's contained in). If you don't have these directory names,
...
zem =2.6636# redshift of the quasar
coem=zem+1.
