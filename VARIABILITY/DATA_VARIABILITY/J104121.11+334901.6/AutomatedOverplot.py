...
quasardirec = 'J104121.11+334901.6/' # Name of the object you are observing (same name as the directory folder it's contained in). If you don't have these directory names,
...
zem =4.121# redshift of the quasar
coem=zem+1.
