...
quasardirec = 'J163514.75+415230.2/' # Name of the object you are observing (same name as the directory folder it's contained in). If you don't have these directory names,
...
zem =2.314# redshift of the quasar
coem=zem+1.
