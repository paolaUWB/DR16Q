...
quasardirec = 'J160852.73+584513.5/' # Name of the object you are observing (same name as the directory folder it's contained in). If you don't have these directory names,
...
zem =2.385# redshift of the quasar
coem=zem+1.
