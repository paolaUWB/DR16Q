...
quasardirec = 'J004659.89+180739.6/' # Name of the object you are observing (same name as the directory folder it's contained in). If you don't have these directory names,
...
zem =2.762# redshift of the quasar
coem=zem+1.
