...
quasardirec = 'J075916.12+092743.0/' # Name of the object you are observing (same name as the directory folder it's contained in). If you don't have these directory names,
...
zem =2.635# redshift of the quasar
coem=zem+1.
