...
quasardirec = 'J123830.71+480003.4/' # Name of the object you are observing (same name as the directory folder it's contained in). If you don't have these directory names,
...
zem =2.846# redshift of the quasar
coem=zem+1.
