...
quasardirec = 'J085119.10+134652.5/' # Name of the object you are observing (same name as the directory folder it's contained in). If you don't have these directory names,
...
zem =3.204# redshift of the quasar
coem=zem+1.
