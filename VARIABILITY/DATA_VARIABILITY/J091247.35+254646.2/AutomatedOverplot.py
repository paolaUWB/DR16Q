...
quasardirec = 'J091247.35+254646.2/' # Name of the object you are observing (same name as the directory folder it's contained in). If you don't have these directory names,
...
zem =2.015# redshift of the quasar
coem=zem+1.
