...
quasardirec = 'J234448.62+165312.2/' # Name of the object you are observing (same name as the directory folder it's contained in). If you don't have these directory names,
...
zem =2.395# redshift of the quasar
coem=zem+1.

wavelength_emit1_initial = 1225.  # left xlim in restframe
wavelength_emit2_initial = 1600.  # right xlim in restframe

vmin = [-39737.01677] # make smaller to move right line right (bigger to move right line left) For absorption shading
vmax = [-42040.43076] # make bigger to move left line left (smaller to move left line right)
...
for k in range(0,len(vmin)):
    if CIV_abs == 'yes':
        ...
        ay3.text(CIVll*(1.+zabs_min[k])-30.,0.5-0.1*k,'CIV',color=color[0],fontname='serif',weight='bold')
