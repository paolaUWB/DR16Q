...
quasardirec = 'J123615.42+515917.9/' # Name of the object you are observing (same name as the directory folder it's contained in). If you don't have these directory names,
...
zem =2.145# redshift of the quasar
coem=zem+1.
