...
quasardirec = 'J085117.41+301838.7/' # Name of the object you are observing (same name as the directory folder it's contained in). If you don't have these directory names,
...
zem =1.914# redshift of the quasar
coem=zem+1.
