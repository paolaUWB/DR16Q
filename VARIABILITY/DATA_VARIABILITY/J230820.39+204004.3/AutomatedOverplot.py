...
quasardirec = 'J230820.39+204004.3/' # Name of the object you are observing (same name as the directory folder it's contained in). If you don't have these directory names,
...
zem =3.623# redshift of the quasar
coem=zem+1.
