...
quasardirec = 'J094734.19+142116.9/' # Name of the object you are observing (same name as the directory folder it's contained in). If you don't have these directory names,
...
zem =3.031# redshift of the quasar
coem=zem+1.
