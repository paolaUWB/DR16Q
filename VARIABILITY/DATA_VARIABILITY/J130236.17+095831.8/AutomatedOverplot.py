...
quasardirec = 'J130236.17+095831.8/' # Name of the object you are observing (same name as the directory folder it's contained in). If you don't have these directory names,
...
zem =2.072# redshift of the quasar
coem=zem+1.
