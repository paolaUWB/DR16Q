...
quasardirec = 'J162349.61+505501.1/' # Name of the object you are observing (same name as the directory folder it's contained in). If you don't have these directory names,
...
zem =2.615# redshift of the quasar
coem=zem+1.
