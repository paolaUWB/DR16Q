...
quasardirec = 'J120821.01+090130.4/' # Name of the object you are observing (same name as the directory folder it's contained in). If you don't have these directory names,
...
zem =2.079# redshift of the quasar
coem=zem+1.
