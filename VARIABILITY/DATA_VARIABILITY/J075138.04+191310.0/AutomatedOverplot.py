...
quasardirec = 'J075138.04+191310.0/' # Name of the object you are observing (same name as the directory folder it's contained in). If you don't have these directory names,
...
zem =2.861# redshift of the quasar
coem=zem+1.
...
colors_norm = ['#2495DF','#C7301E', '#24DF35', '#7b03fc', '#1417d9'] #Colors the program will run through
colors_dered = ['#2495DF','#C7301E', '#24DF35', '#7b03fc', '#1417d9']
