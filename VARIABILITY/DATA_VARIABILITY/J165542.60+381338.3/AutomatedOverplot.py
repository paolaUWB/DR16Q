...
quasardirec = 'J165542.60+381338.3/' # Name of the object you are observing (same name as the directory folder it's contained in). If you don't have these directory names,
...
zem =1.945# redshift of the quasar
coem=zem+1.
