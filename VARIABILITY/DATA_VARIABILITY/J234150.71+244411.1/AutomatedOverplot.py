...
quasardirec = 'J234150.71+244411.1/' # Name of the object you are observing (same name as the directory folder it's contained in). If you don't have these directory names,
...
zem =2.32# redshift of the quasar
coem=zem+1.
