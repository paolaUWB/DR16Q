...
quasardirec = 'J114851.46+231340.4/' # Name of the object you are observing (same name as the directory folder it's contained in). If you don't have these directory names,
...
zem =3.083# redshift of the quasar
coem=zem+1.
