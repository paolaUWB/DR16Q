...
quasardirec = 'J143212.86+113953.1/' # Name of the object you are observing (same name as the directory folder it's contained in). If you don't have these directory names,
...
zem =3.003# redshift of the quasar
coem=zem+1.
