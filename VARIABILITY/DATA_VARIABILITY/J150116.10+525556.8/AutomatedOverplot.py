...
quasardirec = 'J150116.10+525556.8/' # Name of the object you are observing (same name as the directory folder it's contained in). If you don't have these directory names,
...
zem =3.851# redshift of the quasar
coem=zem+1.
