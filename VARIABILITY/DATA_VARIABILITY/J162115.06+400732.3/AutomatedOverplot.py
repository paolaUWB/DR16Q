...
quasardirec = 'J162115.06+400732.3/' # Name of the object you are observing (same name as the directory folder it's contained in). If you don't have these directory names,
...
zem =2.208# redshift of the quasar
coem=zem+1.
