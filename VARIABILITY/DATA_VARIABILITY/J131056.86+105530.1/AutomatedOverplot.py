...
quasardirec = 'J131056.86+105530.1/' # Name of the object you are observing (same name as the directory folder it's contained in). If you don't have these directory names,
...
zem =4.479# redshift of the quasar
coem=zem+1.
