...
from utility_functions import print_to_file, read_file
...
zem_DR16, snr_DR16, spectra_list_DR16 = read_file(EHVO_DR16_FILE)
...
for i in range(len(fits_PLATE)): #750414 spectra total in DR16Q fits file
    ...
    # print_to_file(fits_duplicates[i], os.getcwd() + '/fits_duplicates2.txt')
